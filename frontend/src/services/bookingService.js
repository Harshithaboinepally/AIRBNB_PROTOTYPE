...
const bookingService = {
  ...
  createBooking: async (bookingData) => {
    bookingData.topic = "booking_events";
    const response = await api.post("/kafka-gateway/api/publish", bookingData);
  ...
  getTravelerBookings: async (status) => {
    ...
    const response = await api.get("/bookings/traveler", { params, topic:  });
    return response.data;
  },
